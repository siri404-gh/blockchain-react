            ...
            <form role="form" key='1' onSubmit={self.saveToDB}>
                ...
                <div  id='profile' className='collapse'>
                    ...
                    <div className='row'>
                        ...
                        <div className="form-group col-md-4">
                            <label htmlFor="">SSN Number</label>
                    ...
                    {/*}<div className='row'>
                        <div className="form-group col-md-8">
                            <label htmlFor="">Remarks</label>
                            <textarea  className="form-control"  id="remarks2" value={self.state.remarks2} onChange={self.append}/>
                        </div>
                    </div>
                    <div className='row'>
                        <div className="form-group col-md-8">
                            <label htmlFor="">Remarks</label>
                            <textarea  className="form-control"  id="remarks3" value={self.state.remarks3} onChange={self.append}/>
                        </div>
                    </div>
                    <div className='row'>
                        <div className="form-group col-md-8">
                            <label htmlFor="">Remarks</label>
                            <textarea  className="form-control"  id="remarks4" value={self.state.remarks4} onChange={self.append}/>
                        </div>
                    </div>
                    <div className='row'>
                        <div className="form-group col-md-8">
                            <label htmlFor="">Remarks</label>
                            <textarea  className="form-control"  id="remarks5" value={self.state.remarks5} onChange={self.append}/>
                        </div>
                    </div>*/}
                    <div className='row'>
                        <div className="form-group col-md-8">
